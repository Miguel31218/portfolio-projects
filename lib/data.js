...
export const profile = {
  ...
  location: "Lima, Perú",
  bio: "Construyo productos SaaS de punta a punta: interfaces en React, backends en Node.js y automatización con IA. Actualmente ampliando hacia ciencia de datos.",
  terminalLines: [
    { prompt: "~", cmd: "whoami" },
