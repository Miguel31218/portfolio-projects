...
export const profile = {
  name: "Miguel",
  role: "Desarrollador Full Stack — SaaS & Automatización con IA",
  location: "Lima, Perú",
  bio: "Construyo productos SaaS de punta a punta: interfaces en React, backends en Node.js y automatización con IA sobre WhatsApp. Actualmente ampliando hacia ciencia de datos para cerrar el ciclo entre construir el producto y entender lo que dicen sus datos.",
  terminalLines: [
    { prompt: "~", cmd: "whoami" },
    { output: "full-stack developer · SaaS builder" },
    { prompt: "~", cmd: "cat stack.txt" },
    { output: "React · Node.js · Supabase · Next.js" },
...
export const projectCategories = [
  { id: "saas", label: "Software as a Service (SaaS)", accent: "amber" },
  { id: "web", label: "Desarrollo Web", accent: "amber" },
  { id: "data", label: "Ciencia de Datos", accent: "mint" },
];
